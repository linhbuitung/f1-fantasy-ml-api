...
def build_features_from_dto(dto: Dict) -> Dict:
    """
    ...
    driver_nationality = drv_row.iloc[0]["nationality"] if not drv_row.empty and "nationality" in drv_row.columns else None
